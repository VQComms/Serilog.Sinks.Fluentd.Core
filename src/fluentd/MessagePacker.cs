    ...
    internal class MessagePacker
    {
        ...
        private MessagePackObject CreateTypedMessagePackObject(Type type, object obj, bool first = false)
        {
            ...
            using (var d = new DisposeWithAction(() => _nestCount--))
            {
                ...
                if (type.GetTypeInfo().IsEnum) return new MessagePackObject(obj.ToString());
                ...
                else if (type.GetTypeInfo().ImplementedInterfaces.Any(i => i == typeof(System.Collections.IEnumerable)))
                {
